  ...
  return (
    <section id="hero" className="flex flex-col md:flex-row px-5 py-32 bg-primary justify-center">
        <div className="md:w-1/2 flex flex-col">
             ...
             <p className="text-4xl text-white">{config.subtitle}</p>
         
             <div className="flex gap-4 py-5">
                <a href="https://www.linkedin.com/in/keerthana-kannan05/" className="text-white"><CiLinkedin size={42} /></a>
                <a href="https://github.com/keerthi05k" className="text-white"><FaGithub size={38} /></a>
             </div>
        </div>
