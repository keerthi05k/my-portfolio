        ...
        <section id="resume" className="flex flex-col md:flex-row bg-secondary px-5 py-32 ">
            ...
            <div className="md:w-1/2 flex justify-center">
                <div className="flex flex-col justify-center text-white">
                    ...
                    <p className="text-justify pb-5">You Can View My Resume <a target="_blank" className="btn" href="https://drive.google.com/drive/folders/1a7YNysV9KzAPKdivs5GNd0j1Oadd1Cys">Download</a></p>
                </div>
            </div>
        </section>
    )
